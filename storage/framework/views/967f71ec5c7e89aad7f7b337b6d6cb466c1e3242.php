...
<head>
    ...
    <title> <?php echo $__env->yieldContent('title_prefix', config('adminlte.title_prefix', '')); ?>
            <?php echo $__env->yieldContent('title', config('app.name', 'License Server')); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/adminlte/vendor/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')); ?>">
    <!-- Font Awesome -->
...
<script src="<?php echo e(asset('vendor/adminlte/vendor/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')); ?>"></script>
...
<?php if(config('adminlte.plugins.mask')): ?>
    <!-- JQuery Mask -->
